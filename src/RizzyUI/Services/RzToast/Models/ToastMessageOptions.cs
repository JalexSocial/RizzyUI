...
using ToastEffect = RizzyUI.Services.RzToast.ToastEffect;
using ToastType = RizzyUI.Services.RzToast.ToastType;

namespace RizzyUI.Services.RzToast.Models;
...
public record class ToastMessageOptions
{
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public RzToast.ToastPosition? Position { get; init; }
