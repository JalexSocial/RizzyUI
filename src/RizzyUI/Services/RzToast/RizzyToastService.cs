using ToastMessageOptions = RizzyUI.Services.RzToast.Models.ToastMessageOptions;
...
public class RizzyToastService : IRizzyToastService
{
    ...
    /// </summary>
    private readonly List<Models.ToastMessage> _notifications = new();
    ...
    /// </summary>
    private static string GetDefaultTitle(RzToast.ToastStatus status)
    {
        return status switch
        {
            RzToast.ToastStatus.Success => "Success",
            RzToast.ToastStatus.Error => "Error",
            RzToast.ToastStatus.Warning => "Warning",
            RzToast.ToastStatus.Info => "Info",
    ...
    /// </summary>
    private void AddToast(RzToast.ToastStatus status, string title, string text, ToastMessageOptions? options)
    {
        // Create the base message
        var message = new Models.ToastMessage
        {
            Status = status,
    ...
    public void Success(string text, string? title = null, ToastMessageOptions? options = null) =>
        AddToast(RzToast.ToastStatus.Success, title ?? GetDefaultTitle(RzToast.ToastStatus.Success), text, options);
    ...
    public void Warning(string text, string? title = null, ToastMessageOptions? options = null) =>
        AddToast(RzToast.ToastStatus.Warning, title ?? GetDefaultTitle(RzToast.ToastStatus.Warning), text, options);
    ...
    public void Information(string text, string? title = null, ToastMessageOptions? options = null) =>
        AddToast(RzToast.ToastStatus.Info, title ?? GetDefaultTitle(RzToast.ToastStatus.Info), text, options);
    ...
    public void Error(string text, string? title = null, ToastMessageOptions? options = null) =>
        AddToast(RzToast.ToastStatus.Error, title ?? GetDefaultTitle(RzToast.ToastStatus.Error), text, options);
    ...
    public void Custom(Models.ToastMessage notification)
    {
    ...
    public List<Models.ToastMessage> ReadAllNotifications()
    {
