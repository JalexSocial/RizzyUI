...
public partial class RzSidebarLinkItem : RzComponent
{
    ...
    [CascadingParameter] public RzSidebarLinkItem? Parent { get; set; }
    ...
    [Parameter] public RenderFragment? TrailerContent { get; set; }
    /// <summary> Gets or sets a value indicating whether the link item acts as a collapsible section header. Defaults to false. </summary>
    ...
    protected internal bool HasChildren { get => _hasChildren; set { if (_hasChildren != value) { _hasChildren = value; StateHasChanged(); } } }
    /// <summary> Gets the unique ID for the collapsible button element. </summary>
    protected string ButtonId => _buttonId;
    /// <summary> Gets the unique ID for the collapsible content element. </summary>
    protected string CollapseId => _collapseId;
    ...
    protected string ChevronCollapsedClass => Theme.RzSidebarLinkItem.GetChevronRotationCss(false); // Get collapsed class
    ...
    protected override void OnInitialized()
    {
        ...
        if (Collapsible)
        {
            ...
            _buttonId = $"rzbtn-{guid}";
            _collapseId = $"rzclps-{guid}";
        }
