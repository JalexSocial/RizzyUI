...
public partial class RzSidebar : RzComponent
{
    ...
    /// <summary> Optional content for the <see cref="RzNavbar"/> component, rendered above the sidebar/main content. If set, adjusts layout spacing. </summary>
