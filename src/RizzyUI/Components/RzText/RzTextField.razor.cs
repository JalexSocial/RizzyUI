...
public partial class RzTextField : RzComponent
{
    ...
    /// <summary> Gets or sets a value indicating whether the field is marked as required (adds an indicator to the label). Defaults to false. </summary>
    ...
    protected override string? RootClass() =>
        TwMerge.Merge(AdditionalAttributes); // Styling is primarily handled by the nested RzField component
}
