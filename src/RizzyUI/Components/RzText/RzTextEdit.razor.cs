...
using Blazicons;
using Rizzy.Components; // For RzInputText
...
public partial class RzTextEdit : InputBase<string> // Inherits from InputBase<string>
{
    ...
    [CascadingParameter] public EditContext? EditContext { get; set; } // Cascaded EditContext
    ...
    protected override void OnParametersSet()
    {
        ...
        _placeholder = GetParameterValue("placeholder", Placeholder); // Get placeholder from attributes or Placeholder prop
    ...
    protected override string? RootClass() =>
        TwMerge.Merge(AdditionalAttributes, InputClass); // RzInputText handles merging its class
