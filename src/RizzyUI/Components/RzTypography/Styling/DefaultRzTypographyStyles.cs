...
public class DefaultRzTypographyStyles : RzStylesBase.RzTypographyStylesBase // Not sealed
{
    ...
    /// <inheritdoc/>
    public override string GetTextWeightCss(TextWeight? weight) => weight switch {
    ...
    /// <inheritdoc/>
    public override string GetTextSizeCss(TextSize? size) => size switch {
    ...
    /// <inheritdoc/>
    public override string GetTextTransformCss(TextTransform? transform) => transform switch {
    ...
    /// <inheritdoc/>
    public override string GetTextDecorationCss(TextDecoration? decoration) => decoration switch {
    ...
    /// <inheritdoc/>
    public override string GetLineHeightCss(Leading? leading) => leading switch {
    ...
    /// <inheritdoc/>
    public override string GetBaseCss(SemanticColor? textColor, TextWeight? weight, TextSize? size, Leading? lineHeight, TextDecoration? decoration, TextTransform? transform)
    {
        // Combine all individual style parts
        return $"{textColor?.ToTextClass() ?? ""} {GetTextWeightCss(weight)} {GetTextSizeCss(size)} {GetLineHeightCss(lineHeight)} {GetTextDecorationCss(decoration)} {GetTextTransformCss(transform)}".Trim();
    }
}
...
public class DefaultRzHeadingStyles : RzStylesBase.RzHeadingStylesBase // Not sealed
{
    ...
    /// <inheritdoc/>
    public override string GetLevelCss(HeadingLevel level) => level switch
    {
