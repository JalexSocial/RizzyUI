...
/// <xmldoc>
/// A container component used to group related <see cref="RzDropdownMenuItem"/> components within an <see cref="RzDropdown"/>.
...
public partial class RzDropdownSection : RzComponent
{
    ...
    protected override string? RootClass() =>
        TwMerge.Merge(AdditionalAttributes, Theme.RzDropdownSection.Section);
}
