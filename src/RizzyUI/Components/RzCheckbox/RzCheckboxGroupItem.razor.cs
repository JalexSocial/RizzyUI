...
public partial class RzCheckboxGroupItem<TValue> : RzComponent
{
    ...
    [CascadingParameter] public RzCheckboxGroup<TValue>? Parent { get; set; }
    ...
    protected override void OnInitialized()
    {
        ...
        this.Element = "label"; // The root element is a label for accessibility
        SetEffectiveIcon();
    }
    ...
    /// <inheritdoc/>
    protected override string? RootClass() => TwMerge.Merge(AdditionalAttributes, LabelClass);
    ...
    protected string GetIconVisibilityCss(bool isChecked) => Theme.RzCheckboxGroupItem.GetIconVisibilityCss(isChecked);
}
