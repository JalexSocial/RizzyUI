...
public partial class RzCardHeader : RzComponent
{
    ...
    [Parameter] public SemanticColor BackgroundColor { get; set; } = SemanticColor.SurfaceAlt;
    ...
    protected override string? RootClass() =>
        TwMerge.Merge(AdditionalAttributes,
            ...
            BackgroundColor != SemanticColor.None ? BackgroundColor.ToBackgroundClass() : Theme.Light.SurfaceAlt.ToCssClassString("bg"),
