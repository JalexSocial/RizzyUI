...
public partial class RzTabPanel : RzComponent
{
    ...
    /// <summary> The unique name identifier for this panel. Must match the Name of the corresponding <see cref="RzTab"/>. Required. </summary>
    ...
    protected string TextColorClass => Theme.RzTabPanel.GetTextColorCss(Parent?.TabTextColor ?? SemanticColor.OnSurface);
    ...
    protected override string? RootClass() =>
         ...
         TwMerge.Merge(AdditionalAttributes, InnerContainerClass, TextColorClass);
}
