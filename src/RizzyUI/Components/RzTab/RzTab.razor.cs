...
public partial class RzTab : RzComponent
{
    ...
    [CascadingParameter] private RzTabStrip? TabStrip { get; set; }
    /// <summary> Injected configuration to get the default theme as fallback. </summary>
    [Inject] private IOptions<RizzyUIConfig>? Config { get; set; }
    /// <summary> The effective theme being used (Cascaded or Default). </summary>
    protected RzTheme Theme { get; set; } = default!;

    /// <summary> The unique name identifier for this tab. Must match the Name of the corresponding <see cref="RzTabPanel"/>. Required. </summary>
    [Parameter, EditorRequired] public required string Name { get; set; } = default!;
    ...
    protected string SelectedTextColorClass => Parent?.SelectedTabTextColor.ToTextClass() ?? Theme.Light.Primary.ToCssClassString("text");
