...
public class FlatpickrOptions
{
    ...
    /// <summary>
    /// Allows preloading of an invalid date. Useful when you're using date strings as default values, or if the input element is optional.
    /// </summary>
    ...
    /// <summary>
    /// Whether calendar should close after date selection. By default, the calendar stays open unless the user clicks outside of it.
    /// </summary>
    ...
    /// <summary>
    /// How the calendar should be positioned with regards to the input. Can accept multiple positioning options like "auto", "above", "below", "auto left", "auto right", etc.
    /// </summary>
    ...
    /// <summary>
    /// Creates a wrapper to position the calendar. Useful if the input is inside a scrollable element or you need the calendar to be positioned in a specific way relative to the input.
    /// </summary>
    ...
    /// <summary>
    /// See https://chmln.github.io/flatpickr/examples/#flatpickr-external-elements. Allows the flatpickr calendar to wrap around a custom input and open/close the calendar when this input is focused or clicked.
    /// </summary>
