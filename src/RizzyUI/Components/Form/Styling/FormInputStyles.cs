...
/// <summary>
/// Marker interface for components that consume base form-input styling.
/// </summary>
public interface IHasFormInputStylingProperties { }

/// <summary>
/// Slot definitions shared by form input components.
/// </summary>
...
/// <summary>
/// Base style configuration reused by input components.
/// </summary>
public static class FormInputStyles
{
    /// <summary>
    /// Gets the default Tailwind Variants descriptor for form inputs.
    /// </summary>
