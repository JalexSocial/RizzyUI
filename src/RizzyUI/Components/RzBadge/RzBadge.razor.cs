...
/// <xmldoc>
/// A badge component for displaying labels with various styles and colors, determined by the active <see cref="RzTheme"/>.
/// </xmldoc>
public partial class RzBadge : RzComponent
{
    ...
    [Parameter] public SemanticColor Color { get; set; } = SemanticColor.SurfaceAlt;
