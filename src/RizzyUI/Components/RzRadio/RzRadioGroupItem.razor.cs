...
using Blazicons;
using Rizzy.Components; // For RzInputRadio
using Rizzy.Utility; // For IdGenerator
...
public partial class RzRadioGroupItem<TValue> : RzComponent
{
    ...
    [CascadingParameter] public RzRadioGroup<TValue>? ParentRadioGroup { get; set; }
    ...
    [Parameter] public string Id { get; set; } = IdGenerator.UniqueId("rzrd");
