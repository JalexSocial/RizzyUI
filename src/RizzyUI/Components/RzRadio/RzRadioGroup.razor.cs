...
using Blazicons;
using Rizzy.Components; // For RzInputRadioGroup
...
/// <xmldoc>
/// Represents a group of radio buttons (<see cref="RzRadioGroupItem{TValue}"/>) where only one option can be selected at a time.
...
public partial class RzRadioGroup<TValue> : RzComponent
{
    ...
    protected override string? RootClass()
    {
        ...
        return TwMerge.Merge(AdditionalAttributes, styles.Container, styles.GetGridColumnsCss(Orientation, _items.Count));
    }
}
