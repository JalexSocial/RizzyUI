...
public partial class RzEventViewer : RzComponent<RzEventViewer.Slots>
{
    ...
    public static readonly TvDescriptor<RzComponent<Slots>, Slots> DefaultDescriptor = new(
        ...
        slots: new()
        {
            ...
            [s => s.Console] = "h-64 w-full overflow-y-auto bg-background p-2",
            ...
            [s => s.RowToggle] = "relative inline-flex size-6 items-center justify-center rounded transition-transform duration-150",
