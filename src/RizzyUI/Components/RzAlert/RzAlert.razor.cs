...
/// <xmldoc>
/// Represents an alert component that displays a message with optional icon, variant, and dismiss functionality. Styling is handled by the active theme.
/// </xmldoc>
public partial class RzAlert : RzComponent
{
    ...
    [Parameter] public AlertVariant Variant { get; set; } = AlertVariant.Information;
    ...
    protected override string? RootClass() =>
        TwMerge.Merge(AdditionalAttributes, Theme.RzAlert.Container, Theme.RzAlert.GetVariantCss(Variant));
    ...
    internal string IconContainerClass => Theme.RzAlert.IconContainer + (Pulse ? "" : " " + _bgLighter) + " " + _iconColor;
