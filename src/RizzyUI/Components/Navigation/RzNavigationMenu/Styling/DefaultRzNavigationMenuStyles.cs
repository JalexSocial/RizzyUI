...
public sealed class DefaultRzNavigationMenuStyles : RzStylesBase.RzNavigationMenuStylesBase
{
    ...
    /// <inheritdoc />
    public override string Content => "absolute top-0 left-0 w-auto animate-in fade-in zoom-in-90";

    /// <inheritdoc />
    public override string Viewport => "absolute left-0 top-full flex justify-center w-[var(--radix-navigation-menu-viewport-width)] h-[var(--radix-navigation-menu-viewport-height)] origin-top-center overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-lg md:w-auto data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90";
