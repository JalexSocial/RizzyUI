...
{
    /// <summary>
    /// Gets the color for the underline of the selected tab.
    /// </summary>
...
public partial class RzTabStrip : RzComponent<RzTabStripSlots>, IHasTabStripStylingProperties
{
    ...
    /// <summary>
    /// Gets or sets the child content, which should be a series of `RzTab` components.
    /// </summary>
    [Parameter]
    public RenderFragment? ChildContent { get; set; }

    /// <summary>
    /// Gets the color for the underline of the selected tab, inherited from the parent `RzTabs`.
    /// </summary>
