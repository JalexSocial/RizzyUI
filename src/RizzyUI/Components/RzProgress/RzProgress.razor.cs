...
public partial class RzProgress : RzComponent
{
    ...
    [Parameter] public StatusColor Variant { get; set; } = StatusColor.Primary;
    /// <summary> Gets or sets the aria-label for accessibility. Defaults to "Progress Bar". </summary>
    [Parameter] public string AriaLabel { get; set; } = "Progress Bar";
    ...
    protected string InnerBarClass => $"{Theme.RzProgress.InnerBarBase} {Theme.RzProgress.GetInnerBarVariantCss(Variant)}";
    ...
    protected override string? RootClass() =>
        TwMerge.Merge(AdditionalAttributes, Theme.RzProgress.Container);
