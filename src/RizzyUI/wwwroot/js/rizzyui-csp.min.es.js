...
function ps(e, t) {
  let n = {};
  at(n, e);
  let i = [n, ...ge(e)], r = typeof t == "function" ? Si(i, t) : ms(i, t, e);
...
var Vt = !1, Fe = /* @__PURE__ */ new Map(), Ti = Symbol();
function ys(e) {
  Vt = !0;
  let t = Symbol();
  Ti = t, Fe.set(t, []);
...
function ws(e, t) {
  ...
  gi(e, t.original, s);
  let o = () => {
    e._x_ignore || e._x_ignoreSelf || (i.inline && i.inline(e, t, r), i = i.bind(i, e, t, r), Vt ? Fe.get(Ti).push(i) : i());
  };
...
var Ln = !1;
function Es() {
  Ln && F("Alpine has already been initialized on this page. Calling Alpine.start() more than once can cause problems."), Ln = !0, document.body || F("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?"), Be(document, "alpine:init"), Be(document, "alpine:initializing"), fn(), rs((t) => J(t, me)), cn((t) => Ae(t)), pi((t, n) => {
    mn(t, n).forEach((i) => i());
  });
...
function qi(e, t, n, i = []) {
  switch (e._x_bindings || (e._x_bindings = Ie({})), e._x_bindings[t] = n, t = i.includes("camel") ? Ys(t) : t, t) {
    case "value":
      Bs(e, n);
      break;
    case "style":
...
function Ui(e, t, n) {
  [null, void 0, !1].includes(n) && Gs(t) ? e.removeAttribute(t) : (Yi(t) && (n = t), Vs(e, t, n));
}
function Vs(e, t, n) {
...
function Js(e, t, n) {
  return e._x_bindings && e._x_bindings[t] !== void 0 ? e._x_bindings[t] : Ki(e, t, n);
}
...
function Ki(e, t, n) {
  ...
  return i === null ? typeof n == "function" ? n() : n : i === "" ? !0 : Yi(t) ? !![t, "true"].includes(i) : i;
}
function _n(e) {
...
var fo = Object.freeze({}), ho = Object.prototype.hasOwnProperty, Et = (e, t) => ho.call(e, t), fe = Array.isArray, je = (e) => nr(e) === "[object Map]", po = (e) => typeof e == "string", En = (e) => typeof e == "symbol", It = (e) => e !== null && typeof e == "object", go = Object.prototype.toString, nr = (e) => go.call(e), ir = (e) => nr(e).slice(8, -1), In = (e) => po(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, mo = (e) => {
  const t = /* @__PURE__ */ Object.create(null);
  return (n) => t[n] || (t[n] = e(n));
}, bo = mo((e) => e.charAt(0).toUpperCase() + e.slice(1)), rr = (e, t) => e !== t && (e === e || t === t), Zt = /* @__PURE__ */ new WeakMap(), Re = [], U, he = Symbol("iterate"), Xt = Symbol("Map key iterate");
function vo(e) {
...
function _o(e, t) {
  const n = function() {
    ...
    if (!Re.includes(n)) {
      sr(n);
      try {
        return Io(), Re.push(n), U = n, e();
      } finally {
        Re.pop(), or(), U = Re[Re.length - 1];
      }
    }
  };
...
function re(e, t, n, i, r, s) {
  ...
  if (t === "clear")
    ...
    switch (n !== void 0 && l(o.get(n)), t) {
      case "add":
        fe(e) ? In(n) && l(o.get("length")) : (l(o.get(he)), je(e) && l(o.get(Xt)));
        break;
      case "delete":
...
var So = /* @__PURE__ */ uo("__proto__,__v_isRef,__isVue"), ar = new Set(Object.getOwnPropertyNames(Symbol).map((e) => Symbol[e]).filter(En)), Co = /* @__PURE__ */ lr(), To = /* @__PURE__ */ lr(!0), Fn = /* @__PURE__ */ Oo();
function Oo() {
  const e = {};
...
}, Cn = (e) => It(e) ? An(e) : e, Tn = (e) => It(e) ? hr(e) : e, On = (e) => e, St = (e) => Reflect.getPrototypeOf(e);
function Je(e, t, n = !1, i = !1) {
  e = e.__v_raw;
  const r = O(e), s = O(t);
  t !== s && !n && B(r, "get", t), !n && B(r, "get", s);
  const { has: o } = St(r), a = i ? On : n ? Tn : Cn;
  if (o.call(r, t))
    return a(e.get(t));
  if (o.call(r, s))
    return a(e.get(s));
...
H("id", (e, { cleanup: t }) => (n, i = null) => {
  let r = `${n}${i ? `-${i}` : ""}`;
  return Ko(e, r, t, () => {
    let s = Uo(e, n), o = s ? s._x_ids[n] : gr(n);
    return i ? `${n}-${o}-${i}` : `${n}-${o}`;
  });
});
_t((e, t) => {
...
function Mt(e, t, n, i) {
  return A(() => {
    ...
    if (_n(e))
      if (Array.isArray(i)) {
        let r = null;
        return t.includes("number") ? r = Dt(n.target.value) : t.includes("boolean") ? r = rt(n.target.value) : r = n.target.value, n.target.checked ? i.includes(r) ? i : i.concat([r]) : i.filter((s) => !ta(s, r));
      } else
      ...
      {
        let r;
        return Gi(e) ? n.target.checked ? r = n.target.value : r = i : r = n.target.value, t.includes("number") ? Dt(r) : t.includes("boolean") ? rt(r) : t.includes("trim") ? r.trim() : r;
      }
    }
  });
}
  ...
  n((o) => {
    ...
    if (r(o))
      o = Object.entries(o).map(([h, g]) => {
        let x = Un(t, g, h, o);
        i((E) => {
          u.includes(E) && F("Duplicate key on x-for", e), u.push(E);
    ...
    for (let h = 0; h < f.length; h++) {
      ...
      A(() => {
        I || F('x-for ":key" is undefined or invalid', s, x, a), I.after(w), E.after(I), I._x_currentIfEl && I.after(I._x_currentIfEl), w.before(E), E._x_currentIfEl && E.after(E._x_currentIfEl), w.remove();
      }), I._x_refreshXForScope(c[u.indexOf(x)]);
    }
    for (let h = 0; h < d.length; h++) {
      let [g, x] = d[h], E = g === "template" ? s : a[g];
      E._x_currentIfEl && (E = E._x_currentIfEl);
      let I = c[x], w = u[x], p = document.importNode(s.content, !0).firstElementChild, b = Ie(I);
      Ye(p, b, s), p._x_refreshXForScope = (_) => {
        Object.entries(_).forEach(([C, S]) => {
          b[C] = S;
        });
      }, A(() => {
        E.after(p), oe(() => J(p))();
      }), typeof w == "object" && F("x-for key cannot be an object, it must be a string or an integer", s), a[w] = p;
    }
    ...
    if (s.tabbableGroups.length > 0) {
      ...
      if (C < 0)
        ...
        var $ = Qn(s.tabbableGroups, function(z) {
          var P = z.firstTabbableNode;
          return b === P;
        });
        if ($ < 0 && (S.container === b || st(b, r.tabbableOptions) && !tt(b, r.tabbableOptions) && !S.nextTabbableNode(b, !1)) && ($ = C), $ >= 0) {
          var R = $ === 0 ? s.tabbableGroups.length - 1 : $ - 1, L = s.tabbableGroups[R];
          _ = L.lastTabbableNode;
        }
      } else {
        var V = Qn(s.tabbableGroups, function(z) {
          var P = z.lastTabbableNode;
          return b === P;
        });
        if (V < 0 && (S.container === b || st(b, r.tabbableOptions) && !tt(b, r.tabbableOptions) && !S.nextTabbableNode(b)) && (V = C), V >= 0) {
          var D = V === s.tabbableGroups.length - 1 ? 0 : V + 1, ae = s.tabbableGroups[D];
...
`, Ua = Z(function(e) {
  ...
  function e(t) {
    var n = this;
    Pa(this, e), this.notifyOut = Z(function(z) {
      z(n);
    }, "notifyOut");
    var i = t.notificationsGap, r = i === void 0 ? 20 : i, s = t.notificationsPadding, o = s === void 0 ? 20 : s, a = t.status, l = a === void 0 ? "success" : a, c = t.effect, u = c === void 0 ? Pt.FADE : c, d = t.type, f = d === void 0 ? "outline" : d, m = t.title, y = t.text, v = t.showIcon, h = v === void 0 ? !0 : v, g = t.customIcon, x = g === void 0 ? "" : g, E = t.customClass, I = E === void 0 ? "" : E, w = t.speed, p = w === void 0 ? 500 : w, b = t.showCloseButton, _ = b === void 0 ? !0 : b, C = t.autoclose, S = C === void 0 ? !0 : C, $ = t.autotimeout, R = $ === void 0 ? 3e3 : $, L = t.position, V = L === void 0 ? "right top" : L, D = t.customWrapper, ae = D === void 0 ? "" : D;
    if (this.customWrapper = ae, this.status = l, this.title = m, this.text = y, this.showIcon = h, this.customIcon = x, this.customClass = I, this.speed = p, this.effect = u, this.showCloseButton = _, this.autoclose = S, this.autotimeout = R, this.notificationsGap = r, this.notificationsPadding = o, this.type = f, this.position = V, !this.checkRequirements()) {
...
const on = Math.min, we = Math.max, ht = Math.round, Y = (e) => ({
  x: e,
  y: e
}), ul = {
  left: "right",
...
function si(e, t, n) {
  ...
  const s = pe(t), o = Fr(t), a = Pr(o), l = ve(t), c = s === "y", u = i.x + i.width / 2 - r.width / 2, d = i.y + i.height / 2 - r.height / 2, f = i[a] / 2 - r[a] / 2;
  let m;
  switch (l) {
    case "top":
      m = {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const g = ve(r), x = pe(a), E = ve(a) === a, I = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), w = f || (E || !v ? [pt(a)] : hl(a)), p = y !== "none";
      ...
      if (S = [...S, {
        ...
        var $, R;
        const D = ((($ = s.flip) == null ? void 0 : $.index) || 0) + 1, ae = b[D];
        if (ae) {
          var L;
          const P = d === "alignment" ? x !== pe(ae) : !1, q = ((L = S[0]) == null ? void 0 : L.overflows[0]) > 0;
          if (!P || q)
            return {
              data: {
                index: D,
        ...
        let z = (R = S.filter((P) => P.overflows[0] <= 0).sort((P, q) => P.overflows[1] - q.overflows[1])[0]) == null ? void 0 : R.placement;
        if (!z)
          switch (m) {
            case "bestFit": {
              var V;
              const P = (V = S.filter((q) => {
                if (p) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: n,
        y: i
      }, u = await zr(t, l), d = pe(ve(r)), f = Dr(d);
      let m = c[f], y = c[d];
      if (s) {
...
function jr(e) {
  const t = se(e);
  return Ee(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : K(t) && Ge(t) ? t : jr(t);
}
function Wr(e, t, n) {
  var i;
  t === void 0 && (t = []);
...
function Ue(e, t, n, i) {
  ...
  if (s) {
    ...
    let y = f, v = ln(y);
    for (; v && i && m !== y; ) {
      const h = xe(v), g = v.getBoundingClientRect(), x = W(v), E = g.left + (v.clientLeft + parseFloat(x.paddingLeft)) * h.x, I = g.top + (v.clientTop + parseFloat(x.paddingTop)) * h.y;
...
function Nl(e, t) {
  const n = Ue(e, !0, t === "fixed"), i = n.top + e.clientTop, r = n.left + e.clientLeft, s = K(e) ? xe(e) : Y(1), o = e.clientWidth * s.x, a = e.clientHeight * s.y, l = r * s.x, c = i * s.y;
  return {
    width: o,
    height: a,
    x: l,
...
function Yr(e, t) {
  const n = se(e);
  return n === t || !j(n) || Ee(n) ? !1 : W(n).position === "fixed" || Yr(n, t);
}
function kl(e, t) {
  const n = t.get(e);
  if (n)
  ...
  for (; j(o) && !Ee(o); ) {
    const a = W(o), l = $n(o);
    !l && a.position === "fixed" && (r = null), (s ? !l && !r : !l && a.position === "static" && !!r && ["absolute", "fixed"].includes(r.position) || Ge(o) && !l && Yr(e, o)) ? i = i.filter((u) => u !== o) : r = a, o = se(o);
  }
  return t.set(e, i), i;
}
function Rl(e) {
...
function Ml(e, t, n) {
  const i = K(t), r = X(t), s = n === "fixed", o = Ue(e, !0, s, t);
  let a = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
function Kr(e, t) {
  ...
  for (; i && El(i) && Ft(i); )
    i = li(i, t);
  return i && Ee(i) && Ft(i) && !$n(i) ? n : i || Il(e) || n;
}
const Dl = async function(e) {
  const t = this.getOffsetParent || Kr, n = this.getDimensions, i = await n(e.floating);
  return {
...
function nc(e) {
  el(e), tl(e), nl(e), il(e), rl(e), sl(e, ze), ol(e), al(e, ze), ll(e), cl(e, ze), zl(e), Bl(e), jl(e), Wl(e), Hl(e), Vl(e), ql(e, ze), Yl(e), Ul(e), Kl(e), Gl(e), Jl(e), Zl(e), Xl(e), Ql(e), ec(e);
}
...
function ic(e) {
  e.directive("rz-init", (t) => {
    queueMicrotask(() => {
      ...
      const n = t.__rzComponent;
      if (!n || typeof n.__initData != "function")
        return;
      let i = {};
      try {
        i = JSON.parse(t.getAttribute("x-rz-init") || "{}");
      } catch (r) {
        console.warn("[RizzyUI] x-rz-init: JSON parse failed. Initializing with empty data.", { error: r, element: t });
      }
      n.__initData(i), t.__rzInitRan = !0;
    });
  });
}
window.RizzyUI.registerModuleOnce = (e, t) => {
  window.RizzyUI.registeredModules.has(e) || (window.RizzyUI.registeredModules.add(e), Alpine.data(e, () => ({
     ...
     */
    __initData(n) {
      this._resolveInitData ? this._resolveInitData(n) : this._initDataPromise = Promise.resolve(n);
    },
    /**
    ...
    async init() {
      const n = this;
      n.$el.__rzComponent = n;
      try {
        let i;
        n._initDataPromise ? i = await n._initDataPromise : (n._initDataPromise = new Promise((a) => {
          n._resolveInitData = a;
        }), queueMicrotask(() => {
          n.$el.hasAttribute("x-rz-init") || n._resolveInitData({});
        }), i = await n._initDataPromise);
        const r = await import(t), s = r && r.default;
        if (typeof s != "function") {
          console.error(`[RizzyUI] Module at '${t}' for component '${e}' did not export a default function.`);
          return;
        }
        const o = s(i ?? {});
        Object.assign(n, o), delete n._initDataPromise, delete n._resolveInitData, typeof o.init == "function" && queueMicrotask(() => o.init.call(n));
      } catch (i) {
        console.error(`[RizzyUI] Failed to load or initialize module '${e}' from '${t}'.`, i);
      }
    }
  })));
};
...
function sc(e) {
  const t = (n, { expression: i, modifiers: r }, { cleanup: s, effect: o }) => {
    ...
    d.forEach((v, h) => {
      const g = m[h];
      if (f) {
        const I = e.evaluate(n, v.childPath, { scope: c });
        g.fromChild = !0, a(u, v.parentPath, I), queueMicrotask(() => {
          g.fromChild = !1;
        });
      } else {
        const I = e.evaluate(n, v.parentPath, { scope: u });
