...
var RzToastManager = class {
	...
	invokeAction(toast) {
		...
		try {
			...
			else if (typeof action.eventName === "string" && action.eventName.trim()) window.dispatchEvent(new CustomEvent(action.eventName, { detail: action.detail ?? {
				id: toast.id,
				status: toast.options.status,
		...
		commands.forEach((command) => {
			...
			switch (command.type) {
				case "show":
					...
					break;
				case "update":
					if (command.id) this.update(command.id, command.options || {});
					break;
				case "dismiss":
	...
	installInputEventListeners() {
		...
		const listener = (event) => {
			...
			else if (event.type === "rz:toast:batch") this.processBatch(detail);
		};
...
var bundleLoaderRegistry = Object.freeze({
	...
	"advanced-input-runtime": () => __vitePreload(() => import("./advanced-input-runtime-CPxY73SZ.js"), [], import.meta.url),
	"calendar-runtime": () => __vitePreload(() => import("./calendar-runtime-D7PUOKyt.js"), [], import.meta.url),
	"table-runtime": () => __vitePreload(() => import("./table-runtime-DSaNFo3H.js"), [], import.meta.url),
	"color-runtime": () => __vitePreload(() => import("./color-runtime-xbFeBwv3.js"), [], import.meta.url),
	"content-visual-runtime": () => __vitePreload(() => import("./content-visual-runtime-BltEqgnS.js"), [], import.meta.url),
	...
	"docs-runtime": () => __vitePreload(() => import("./docs-runtime-De8zc7MY.js"), [], import.meta.url),
	"effects-runtime": () => __vitePreload(() => import("./effects-runtime-BcU_bRqY.js"), [], import.meta.url)
});
//#endregion
...
//# sourceMappingURL=bootstrap-D7iIajoc.js.map