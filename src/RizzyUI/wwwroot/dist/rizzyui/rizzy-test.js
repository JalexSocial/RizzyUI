...
// --------------------------------------------------------------------------------
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('rzAccordion', function () {
  return {
    selected: '',
    allowMultiple: false,
    init: function init() {
...
var v = new (_vendor_aspnet_validation_aspnet_validation__WEBPACK_IMPORTED_MODULE_4___default().ValidationService)();
v.bootstrap({
  watch: true
});
window.validation = v;
...
//# sourceMappingURL=rizzy-test.js.map