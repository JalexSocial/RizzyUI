...
function require(paths, callbackFn, nonce) {
  generateBundleId(paths).then(function (bundleId) {
    if (!_vendor_loadjs_loadjs__WEBPACK_IMPORTED_MODULE_1__["default"].isDefined(bundleId)) {
      (0,_vendor_loadjs_loadjs__WEBPACK_IMPORTED_MODULE_1__["default"])(paths, bundleId, {
        async: false,
        inlineScriptNonce: nonce,
        inlineStyleNonce: nonce
      });
    }
    _vendor_loadjs_loadjs__WEBPACK_IMPORTED_MODULE_1__["default"].ready([bundleId], callbackFn);
  });
}
...
/***/ "./wwwroot/js/vendor/aspnet-validation/aspnet-validation.js":
/*!******************************************************************!*\
  !*** ./wwwroot/js/vendor/aspnet-validation/aspnet-validation.js ***!
  \******************************************************************/
...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return /******/function () {
    ...
    /******/ // The require scope
    /******/
    var __nested_webpack_require_982__ = {};
    /******/
    /************************************************************************/
    ...
    (function () {
      ...
      /******/__nested_webpack_require_982__.d = function (exports, definition) {
        /******/for (var key in definition) {
          /******/if (__nested_webpack_require_982__.o(definition, key) && !__nested_webpack_require_982__.o(exports, key)) {
    ...
    /******/
    (function () {
      /******/__nested_webpack_require_982__.o = function (obj, prop) {
    ...
    (function () {
      ...
      /******/__nested_webpack_require_982__.r = function (exports) {
    ...
    /*!**********************!*\
      !*** ./src/index.ts ***!
      \**********************/
    __nested_webpack_require_982__.r(__nested_webpack_exports__);
    /* harmony export */
    __nested_webpack_require_982__.d(__nested_webpack_exports__, {
      /* harmony export */MvcValidationProviders: function MvcValidationProviders() {
        return /* binding */_MvcValidationProviders;
      },
      /* harmony export */ValidationService: function ValidationService() {
        return /* binding */_ValidationService;
      },
      /* harmony export */isValidatable: function isValidatable() {
        return /* binding */_isValidatable;
      }
      /* harmony export */
    });
     ...
     */
    var _isValidatable = function _isValidatable(element) {
     ...
     */
    var validatableSelector = function validatableSelector(selector) {
    ...
    function getRelativeFormElement(element, selector) {
      ...
      if (dotLocation > -1) {
        ...
        if (_isValidatable(relativeElement)) {
     ...
     */
    var _MvcValidationProviders = /** @class */function () {
     ...
     */
    var _ValidationService = /** @class */function () {
      ...
      ValidationService.prototype.addMvcProviders = function () {
        var mvc = new _MvcValidationProviders();
        // [Required]
      ...
      ValidationService.prototype.trackFormInput = function (form, inputUID) {
        ...
        var cbReset = function cbReset(e) {
          var formInputUIDs = _this.formInputs[formUID];
      ...
      */
      ...
      ValidationService.prototype.resetField = function (inputUID) {
        ...
        var spans = _isValidatable(input) && this.getMessageFor(input);
        if (spans) {
      ...
      ValidationService.prototype.addInput = function (input) {
        ...
        var cb = function cb(event, callback) {
          return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  ...
                  if (!validate) return [2 /*return*/, true];
      ...
      ValidationService.prototype.scanInputs = function (root, cb) {
        ...
        // querySelectorAll does not include the root element itself.
        // we could use 'matches', but that's newer than querySelectorAll so we'll keep it simple and compatible.
        if (_isValidatable(root) && root.getAttribute("data-val") === "true") {
          inputs.push(root);
        }
...
/* harmony import */ var _vendor_aspnet_validation_aspnet_validation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./vendor/aspnet-validation/aspnet-validation */ "./wwwroot/js/vendor/aspnet-validation/aspnet-validation.js");
/* harmony import */ var _vendor_aspnet_validation_aspnet_validation__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_vendor_aspnet_validation_aspnet_validation__WEBPACK_IMPORTED_MODULE_4__);
...
var validationService = new _vendor_aspnet_validation_aspnet_validation__WEBPACK_IMPORTED_MODULE_4__.ValidationService();
...
(0,_alpine_components_js__WEBPACK_IMPORTED_MODULE_5__["default"])(_alpinejs_csp__WEBPACK_IMPORTED_MODULE_0__["default"]);
