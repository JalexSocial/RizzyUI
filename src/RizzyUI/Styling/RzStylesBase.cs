...
using Microsoft.AspNetCore.Components; // Required for RenderFragment type hint if needed later

namespace RizzyUI.Styling;
...
public abstract class RzStylesBase
{
    ...
    public abstract class RzAccordionStylesBase
    {
        ...
        protected RzAccordionStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzAccordionSectionStylesBase
    {
        ...
        protected RzAccordionSectionStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzAlertStylesBase
    {
        ...
        protected RzAlertStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzAlertTitleStylesBase
    {
        ...
        protected RzAlertTitleStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzAlertDescriptionStylesBase
    {
        ...
        protected RzAlertDescriptionStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzAvatarStylesBase
    {
        ...
        protected RzAvatarStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the base CSS classes for the main RzAvatar container element (positioning and object-fit). Size is applied separately. </summary>
        public abstract string Container { get; }
        /// <summary> Gets the CSS classes for the status indicator div (base style, border). Size and color are applied separately. </summary>
        ...
        /// <summary> Gets the base CSS classes for the initials container div (flex, alignment, base colors). Size, shape, and text size are applied separately. </summary>
        public abstract string InitialsContainer { get; }
        /// <summary> Gets the base CSS classes for the placeholder container div (flex, alignment, base colors). Size and shape are applied separately. </summary>
    ...
    public abstract class RzBadgeStylesBase
    {
        ...
        protected RzBadgeStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzBreadcrumbStylesBase
    {
        ...
        protected RzBreadcrumbStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzBreadcrumbItemStylesBase
    {
        ...
        protected RzBreadcrumbItemStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzButtonStylesBase
    {
        ...
        protected RzButtonStylesBase(RzTheme theme) => Theme = theme;
    ...
    /// <summary>
    /// Defines the abstract structure for styling the <see cref="RzButtonGroup"/> component and its interaction with child buttons.
    /// </summary>
    public abstract class RzButtonGroupStylesBase
    {
        ...
        protected RzButtonGroupStylesBase(RzTheme theme) => Theme = theme;
        ...
        /// <summary> Gets the CSS classes applied to buttons that are neither first nor last in a group (corner rounding, border adjustment). </summary>
    ...
    public abstract class RzDarkmodeToggleStylesBase
    {
        ...
        protected RzDarkmodeToggleStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzSearchButtonStylesBase
    {
        ...
        protected RzSearchButtonStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the base CSS classes for the SearchButton button element (layout, border, background, typography, transitions). </summary>
        public abstract string Button { get; }
    ...
    public abstract class RzCardStylesBase
    {
        ...
        protected RzCardStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzCardHeaderStylesBase
    {
        ...
        protected RzCardHeaderStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzCardBodyStylesBase
    {
        ...
        protected RzCardBodyStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzCardFooterStylesBase
    {
        ...
        protected RzCardFooterStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzCardTitleStylesBase
    {
        ...
        protected RzCardTitleStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzCardSubtitleStylesBase
    {
        ...
        protected RzCardSubtitleStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzCardButtonsStylesBase
    {
        ...
        protected RzCardButtonsStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzCheckboxGroupStylesBase
    {
        ...
        protected RzCheckboxGroupStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzCheckboxGroupItemStylesBase
    {
        ...
        protected RzCheckboxGroupItemStylesBase(RzTheme theme) => Theme = theme;
        ...
        /// <summary> Returns the CSS class ("hidden" or "") to control the visibility of the check icon based on the checked state. </summary>
    ...
    public abstract class RzCheckboxGroupFieldStylesBase
    {
        ...
        protected RzCheckboxGroupFieldStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the base CSS classes for the RzCheckboxGroupField container (typically handled by <see cref="RzFieldStylesBase"/>). </summary>
         public abstract string Field { get; }
        /// <summary> Gets the CSS classes applied specifically to the <see cref="RzCheckboxGroup{TValue}"/> when it's rendered inside this field container (e.g., margins). </summary>
    ...
    public abstract class RzCodeViewerStylesBase
    {
        ...
        protected RzCodeViewerStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzDateEditStylesBase
    {
        ...
        protected RzDateEditStylesBase(RzTheme theme) => Theme = theme;
        ...
        /// <summary> Gets the CSS classes for the prepend element div (positioning, layout, padding, border, background, typography). </summary>
        ...
        /// <summary> Gets the base CSS classes for the input element (layout, rounding, border, padding, typography, focus styles). </summary>
    ...
    public abstract class RzDividerStylesBase
    {
        ...
        /// <summary> Gets the CSS classes for the divider style (solid, dashed, dotted) when rendered as an <c>hr</c> (no ChildContent). </summary>
        ...
        /// <summary> Gets the CSS classes for the divider when rendered as a <c>div</c> with ChildContent, including alignment and style for pseudo-elements. </summary>
    ...
    public abstract class RzDropdownStylesBase
    {
        ...
        protected RzDropdownStylesBase(RzTheme theme) => Theme = theme;
        ...
        /// <summary> Gets the CSS classes for the dropdown menu container div (positioning, width, rounding, shadow). Anchor positioning classes are added dynamically. </summary>
        public abstract string MenuContainer { get; }
        /// <summary> Gets the CSS classes for the inner div inside the menu container, which typically holds sections and provides background/border styling. </summary>
    ...
    public abstract class RzDropdownSectionStylesBase
    {
        ...
        protected RzDropdownSectionStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzDropdownMenuItemStylesBase
    {
        ...
        protected RzDropdownMenuItemStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the base CSS classes for the RzDropdownMenuItem anchor (a) element (layout, rounding, cursor, border, padding, typography, transitions, focus styles). </summary>
        ...
        public abstract string TitleSpan { get; }
        /// <summary> Gets the CSS classes for the div displaying the optional count badge (layout, rounding, border, padding, typography). </summary>
    ...
    public abstract class RzEmbeddedPreviewStylesBase
    {
        ...
        protected RzEmbeddedPreviewStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzFieldStylesBase
    {
        ...
        protected RzFieldStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzFieldLabelStylesBase
    {
        ...
        protected RzFieldLabelStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzFieldHelpStylesBase
    {
        ...
        protected RzFieldHelpStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzFormSectionStylesBase
    {
        ...
        protected RzFormSectionStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzHeadingStylesBase
    {
        ...
        protected RzHeadingStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzLinkStylesBase
    {
        ...
        protected RzLinkStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzMarkdownStylesBase
    {
        ...
        protected RzMarkdownStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the base CSS classes for the RzMarkdown container div (prose base, dark mode, text color, max-width reset). </summary>
        public abstract string Container { get; }
    ...
    public abstract class RzNavbarStylesBase
    {
        ...
        protected RzNavbarStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzNumberEditStylesBase
    {
        ...
        protected RzNumberEditStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the CSS classes for the relative div wrapping the input and prepend element. </summary>
        public abstract string InputWrapper { get; }
        /// <summary> Gets the CSS classes for the prepend element div (positioning, layout, padding, border, background, typography). </summary>
        public abstract string PrependElement { get; }
    ...
    public abstract class RzNumberFieldStylesBase
    {
        ...
        protected RzNumberFieldStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the base CSS classes for the RzNumberField container (typically handled by <see cref="RzFieldStylesBase"/>). </summary>
         public abstract string Field { get; }
    }
    #endregion
    ...
    public abstract class RzParagraphStylesBase
    {
        ...
        protected RzParagraphStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzProgressStylesBase
    {
        ...
        protected RzProgressStylesBase(RzTheme theme) => Theme = theme;
        ...
        /// <summary> Gets the CSS classes for the outer progress bar container div (track styling: layout, overflow, rounding, background). </summary>
        public abstract string OuterBar { get; }
        /// <summary> Gets the base CSS classes for the inner progress bar div (value indicator: layout, typography, transitions). Variant styles are applied separately. </summary>
    ...
    public abstract class RzQuickReferenceStylesBase
    {
        ...
        protected RzQuickReferenceStylesBase(RzTheme theme) => Theme = theme;
        ...
        /// <summary> Gets the indentation CSS class (e.g., "ml-4") for a list item based on its heading level relative to the minimum level shown. </summary>
    ...
    public abstract class RzQuickReferenceContainerStylesBase
    {
        ...
        protected RzQuickReferenceContainerStylesBase(RzTheme theme) => Theme = theme;
     ...
     public abstract class RzRadioGroupStylesBase
    {
        ...
        protected RzRadioGroupStylesBase(RzTheme theme) => Theme = theme;
     ...
     public abstract class RzRadioGroupItemStylesBase
    {
        ...
        protected RzRadioGroupItemStylesBase(RzTheme theme) => Theme = theme;
        ...
        public abstract string IconContainer { get; }
        /// <summary> Gets the CSS classes for the main clickable container span (layout, cursor, rounding, border, padding, peer states). </summary>
    ...
    public abstract class RzRadioGroupFieldStylesBase
    {
        ...
        protected RzRadioGroupFieldStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the base CSS classes for the RzRadioGroupField container (typically handled by <see cref="RzFieldStylesBase"/>). </summary>
         public abstract string Field { get; }
        /// <summary> Gets the CSS classes applied specifically to the <see cref="RzRadioGroup{TValue}"/> when it's rendered inside this field container. </summary>
         public abstract string GroupWithinField { get; }
    }
    #endregion
    ...
    public abstract class RzSidebarStylesBase
    {
        ...
        protected RzSidebarStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the base CSS classes for the main RzSidebar container div (which holds the Alpine.js x-data). Usually empty. </summary>
        public abstract string Container { get; }
        ...
        /// <summary> Gets the base CSS classes for the aside element (sidebar container: positioning, width, overflow, background, border, z-index, padding, transitions). </summary>
    ...
    public abstract class RzSidebarLinkItemStylesBase
    {
        ...
        protected RzSidebarLinkItemStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzSidebarLinksStylesBase
    {
        ...
        protected RzSidebarLinksStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzStepsStylesBase
    {
        ...
        protected RzStepsStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the base CSS classes for the RzSteps ordered list (ol) element (layout, gap). </summary>
        public abstract string Container { get; }
        /// <summary> Gets the base CSS classes for the list item (li) element representing a step (layout, positioning, typography). </summary>
        ...
        /// <summary> Gets the base CSS classes for the span representing the step circle when completed (layout, size, rounding, border). </summary>
        ...
        public abstract string CircleCompletedSrText { get; }
         /// <summary> Gets the base CSS classes for the span representing the step circle for current or upcoming steps (layout, size, rounding, border). </summary>
        public abstract string CircleDefaultBase { get; }
        /// <summary> Gets the base CSS classes for the step label span (visibility, width). Status-specific styles are applied separately. </summary>
        ...
        /// <returns>A string of CSS classes.</returns>
        public abstract string GetOrientationCss(Orientation orientation);
        /// <summary> Gets the width CSS class for a step list item based on whether it's the first item (relevant for horizontal layout). </summary>
        ...
        /// <summary> Gets the CSS classes for the connector line between steps, considering orientation, previous step status, and the active color. </summary>
        /// <param name="orientation">The layout orientation.</param>
        ...
        public abstract string GetConnectorCss(Orientation orientation, StepStatus previousStatus, StatusColor activeColor);
        ...
        /// <summary> Gets the variant-specific CSS classes for the step circle based on its status (Current or Upcoming) and the active color. </summary>
    ...
    public abstract class RzTabsStylesBase
    {
        ...
        protected RzTabsStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzTabStripStylesBase
    {
        ...
        protected RzTabStripStylesBase(RzTheme theme) => Theme = theme;
        ...
        /// <summary> Gets the CSS classes for the tab marker div used for selection indication (positioning, size, transitions, pseudo-element setup). </summary>
    ...
    public abstract class RzTabStylesBase
    {
        ...
        protected RzTabStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the base CSS classes for the RzTab button element (positioning, layout, size, cursor, whitespace, rounding, typography, transitions). </summary>
        public abstract string Button { get; }
    ...
    public abstract class RzTabPanelStylesBase
    {
        ...
        protected RzTabPanelStylesBase(RzTheme theme) => Theme = theme;
        ...
        /// <summary> Gets the base CSS classes for the inner content div of the RzTabPanel (padding/background are often applied via attributes). </summary>
        public abstract string InnerContainer { get; }
    ...
    public abstract class RzTextEditStylesBase
    {
        ...
        protected RzTextEditStylesBase(RzTheme theme) => Theme = theme;
        ...
        public abstract string PrependElement { get; }
         /// <summary> Gets the CSS classes for the Blazicon component if PrependIcon is used (text size). </summary>
        public abstract string PrependIconContainer { get; }
        /// <summary> Gets the base CSS classes for the input element (layout, rounding, border, padding, typography, focus styles, initial transition state). </summary>
        public abstract string Input { get; }
    }
     ...
     public abstract class RzTextFieldStylesBase
    {
        ...
        protected RzTextFieldStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the base CSS classes for the RzTextField container (typically handled by <see cref="RzFieldStylesBase"/>). </summary>
         public abstract string Field { get; }
    }
    #endregion
    ...
    public abstract class RzToggleStylesBase
    {
        ...
        protected RzToggleStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the base CSS classes for the RzToggle input (checkbox) element, including base appearance, ::before pseudo-element styles, and checked state styles. </summary>
    ...
    public abstract class RzToggleFieldStylesBase
    {
        ...
        protected RzToggleFieldStylesBase(RzTheme theme) => Theme = theme;
        /// <summary> Gets the base CSS classes for the RzToggleField container (typically handled by <see cref="RzFieldStylesBase"/>). </summary>
        public abstract string Field { get; }
    ...
    /// <summary>
    /// Defines the abstract structure for base typography styling utilities used by components like <see cref="RzHeading"/> and <see cref="RzParagraph"/>.
    /// </summary>
    public abstract class RzTypographyStylesBase
    {
        ...
        protected RzTypographyStylesBase(RzTheme theme) => Theme = theme;
        ...
        public abstract string GetBaseCss(SemanticColor? textColor, TextWeight? weight, TextSize? size, Leading? lineHeight, TextDecoration? decoration, TextTransform? transform);
    }
    #endregion
    ...
    public abstract class RzHtmlElementStylesBase
    {
        ...
        protected RzHtmlElementStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzFragmentComponentStylesBase
    {
        ...
        protected RzFragmentComponentStylesBase(RzTheme theme) => Theme = theme;
    ...
    public abstract class RzArticleStylesBase
    {
        ...
        protected RzArticleStylesBase(RzTheme theme) => Theme = theme;
        ...
        /// <summary> Gets the base CSS classes for the aside element (side content: layout, overflow, padding, typography). Width and positioning are applied separately. </summary>
        ...
        /// <summary> Gets the CSS class for the main container's right padding, used to prevent content overlap with a fixed aside. </summary>
