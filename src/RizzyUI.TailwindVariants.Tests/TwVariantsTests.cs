...
// The component class is now partial to allow the source generator to augment it.
public partial class ButtonComponent : ISlotted<ButtonComponent.ButtonSlots>
{
    ...
    // The Slots class is now nested and partial, matching the enforced pattern.
...
public class TwVariantsTests
{
    ...
    public void Invoke_GetName_ReturnsCorrectSlot()
    {
        ...
        // Assert
        // Updated to use the new nested enum generated by the source generator.
    ...
    {
        // Arrange
        var descriptor = new TvDescriptor<ButtonComponent, ButtonComponent.ButtonSlots>(
            @base: "inline-flex items-center justify-center rounded-md font-medium transition-colors",
            slots: new SlotCollection<ButtonComponent.ButtonSlots>
            {
                [s => s.Icon] = "w-4 h-4",
                [s => s.Label] = "ml-2"
            },
            variants: new VariantCollection<ButtonComponent, ButtonComponent.ButtonSlots>
            {
                {
                    c => c.Variant,
                    new Variant<string, ButtonComponent.ButtonSlots>
                    {
    ...
    public void Invoke_MultipleInvocations_DoesNotMutateDescriptor()
    {
        ...
        var descriptor = new TvDescriptor<TestComponent, TestComponent.TestSlots>(
            @base: "btn",
            variants: new VariantCollection<TestComponent, TestComponent.TestSlots>
            {
                {
                    c => c.Size,
                    new Variant<string, TestComponent.TestSlots>
                    {
                        ["sm"] = "text-sm",
                        ["lg"] = "text-lg"
                    }
    ...
    public void Invoke_WithClassesContainingNullSlot_SkipsNullSlots()
    {
        ...
        var component = new TestComponent
        {
            Classes = new TestComponent.TestSlots
            {
                Title = "font-bold",
