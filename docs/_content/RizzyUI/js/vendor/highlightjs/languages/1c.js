(function(){var hljsGrammar=(function(){'use strict';function _1c(hljs){const UNDERSCORE_IDENT_RE='[A-Za-zА-Яа-яёЁ_][A-Za-zА-Яа-яёЁ_0-9]+';const v7_keywords='далее ';const v8_keywords='возврат вызватьисключение выполнить для если и из или иначе иначеесли исключение каждого конецесли '
...
return _1c;})();hljs.registerLanguage('1c',hljsGrammar);})();