(function(){var hljsGrammar=(function(){'use strict';function isbl(hljs){const UNDERSCORE_IDENT_RE="[A-Za-zА-Яа-яёЁ_!][A-Za-zА-Яа-яёЁ_0-9]*";const FUNCTION_NAME_IDENT_RE="[A-Za-zА-Яа-яёЁ_][A-Za-zА-Яа-яёЁ_0-9]*";const KEYWORD="and и else иначе endexcept endfinally endforeach конецвсе endif конецесли endwhile конецпока "
+"except exitfor finally foreach все if если in в not не or или try while пока ";const sysres_constants="SYSRES_CONST_ACCES_RIGHT_TYPE_EDIT "
...
+"SYSRES_CONST_YES_VALUE ";const base_constants="CR FALSE nil NO_VALUE NULL TAB TRUE YES_VALUE ";const base_group_name_constants="ADMINISTRATORS_GROUP_NAME CUSTOMIZERS_GROUP_NAME DEVELOPERS_GROUP_NAME SERVICE_USERS_GROUP_NAME ";const decision_block_properties_constants="DECISION_BLOCK_FIRST_OPERAND_PROPERTY DECISION_BLOCK_NAME_PROPERTY DECISION_BLOCK_OPERATION_PROPERTY "
+"DECISION_BLOCK_RESULT_TYPE_PROPERTY DECISION_BLOCK_SECOND_OPERAND_PROPERTY ";const file_extension_constants="ANY_FILE_EXTENTION COMPRESSED_DOCUMENT_EXTENSION EXTENDED_DOCUMENT_EXTENSION "
+"SHORT_COMPRESSED_DOCUMENT_EXTENSION SHORT_EXTENDED_DOCUMENT_EXTENSION ";const job_block_properties_constants="JOB_BLOCK_ABORT_DEADLINE_PROPERTY "
...
+"JOB_BLOCK_SUBJECT_PROPERTY ";const language_code_constants="ENGLISH_LANGUAGE_CODE RUSSIAN_LANGUAGE_CODE ";const launching_external_applications_constants="smHidden smMaximized smMinimized smNormal wmNo wmYes ";const link_kind_constants="COMPONENT_TOKEN_LINK_KIND "
+"DOCUMENT_LINK_KIND "
+"EDOCUMENT_LINK_KIND "
+"FOLDER_LINK_KIND "
+"JOB_LINK_KIND "
+"REFERENCE_LINK_KIND "
+"TASK_LINK_KIND ";const lock_type_constants="COMPONENT_TOKEN_LOCK_TYPE EDOCUMENT_VERSION_LOCK_TYPE ";const monitor_block_properties_constants="MONITOR_BLOCK_AFTER_FINISH_EVENT "
...
+"MONITOR_BLOCK_SEARCH_SCRIPT_PROPERTY ";const notice_block_properties_constants="NOTICE_BLOCK_AFTER_FINISH_EVENT "
...
+"NOTICE_BLOCK_SUBJECT_PROPERTY ";const object_events_constants="dseAfterCancel "
+"dseAfterClose "
+"dseAfterDelete "
...
+"SELECTION_END_ROUTE_EVENT ";const object_params_constants="CURRENT_PERIOD_IS_REQUIRED "
+"PREVIOUS_CARD_TYPE_NAME "
+"SHOW_RECORD_PROPERTIES_FORM ";const other_constants="ACCESS_RIGHTS_SETTING_DIALOG_CODE "
...
+"REPEAT_PROCESS_CURRENT_OBJECT_EXCEPTION_NAME ";const privileges_constants="PRIVILEGE_COMPONENT_FULL_ACCESS "
...
+"PRIVILEGES_PSEUDOREFERENCE_CODE ";const pseudoreference_code_constants="ACCESS_TYPES_PSEUDOREFERENCE_CODE "
...
+"VIEWERS_PSEUDOREFERENCE_CODE ";const requisite_ISBCertificateType_values_constants="CERTIFICATE_TYPE_ENCRYPT "
+"CERTIFICATE_TYPE_SIGN "
+"CERTIFICATE_TYPE_SIGN_AND_ENCRYPT ";const requisite_ISBEDocStorageType_values_constants="STORAGE_TYPE_FILE "
+"STORAGE_TYPE_NAS_CIFS "
+"STORAGE_TYPE_SAPERION "
+"STORAGE_TYPE_SQL_SERVER ";const requisite_compType2_values_constants="COMPTYPE2_REQUISITE_DOCUMENTS_VALUE "
+"COMPTYPE2_REQUISITE_TASKS_VALUE "
+"COMPTYPE2_REQUISITE_FOLDERS_VALUE "
+"COMPTYPE2_REQUISITE_REFERENCES_VALUE ";const requisite_name_constants="SYSREQ_CODE "
+"SYSREQ_COMPTYPE2 "
...
+"SYSREQ_WORK_RULES_FOLDER_ID ";const result_constants="RESULT_VAR_NAME RESULT_VAR_NAME_ENG ";const rule_identification_constants="AUTO_NUMERATION_RULE_ID "
...
+"SET_OURFIRM_REQUISITE_RULE_ID ";const script_block_properties_constants="SCRIPT_BLOCK_AFTER_FINISH_EVENT "
+"SCRIPT_BLOCK_BEFORE_START_EVENT "
+"SCRIPT_BLOCK_EXECUTION_RESULTS_PROPERTY "
+"SCRIPT_BLOCK_NAME_PROPERTY "
+"SCRIPT_BLOCK_SCRIPT_PROPERTY ";const subtask_block_properties_constants="SUBTASK_BLOCK_ABORT_DEADLINE_PROPERTY "
...
+"SUBTASK_BLOCK_WAIT_FOR_TASK_COMPLETE_PROPERTY ";const system_component_constants="SYSCOMP_CONTROL_JOBS "
+"SYSCOMP_FOLDERS "
+"SYSCOMP_JOBS "
+"SYSCOMP_NOTICES "
+"SYSCOMP_TASKS ";const system_dialogs_constants="SYSDLG_CREATE_EDOCUMENT "
...
+"SYSDLG_SIGN_MULTIPLE_EDOCUMENTS ";const system_reference_names_constants="SYSREF_ACCESS_RIGHTS_TYPES "
...
+"SYSREF_VIEWERS "
+"SYSREF_WORKING_TIME_CALENDARS ";const table_name_constants="ACCESS_RIGHTS_TABLE_NAME "
+"EDMS_ACCESS_TABLE_NAME "
+"EDOC_TYPES_TABLE_NAME ";const test_constants="TEST_DEV_DB_NAME "
...
+"TEST_SQL_SERVER_NAME ";const using_the_dialog_windows_constants="ATTENTION_CAPTION "
+"cbsCommandLinks "
+"cbsDefault "
...
+"INFORMATION_CAPTION "
+"mrCancel "
+"mrOk ";const using_the_document_constants="EDOC_VERSION_ACTIVE_STAGE_CODE "
+"EDOC_VERSION_DESIGN_STAGE_CODE "
+"EDOC_VERSION_OBSOLETE_STAGE_CODE ";const using_the_EA_and_encryption_constants="cpDataEnciphermentEnabled "
...
+"cpSubjSimpleName "
+"cpValidFromDate "
+"cpValidToDate ";const using_the_ISBL_editor_constants="ISBL_SYNTAX "+"NO_SYNTAX "+"XML_SYNTAX ";const wait_block_properties_constants="WAIT_BLOCK_AFTER_FINISH_EVENT "
+"WAIT_BLOCK_BEFORE_START_EVENT "
+"WAIT_BLOCK_DEADLINE_PROPERTY "
+"WAIT_BLOCK_IS_RELATIVE_DEADLINE_PROPERTY "
+"WAIT_BLOCK_NAME_PROPERTY "
+"WAIT_BLOCK_RELATIVE_DEADLINE_TYPE_PROPERTY ";const sysres_common_constants="SYSRES_COMMON "
+"SYSRES_CONST "
+"SYSRES_MBFUNC "
+"SYSRES_SBDATA "
+"SYSRES_SBGUI "
...
+"SYSRES_SBREFDSC "
+"SYSRES_SQLERRORS "
+"SYSRES_SYSCOMP ";const CONSTANTS=sysres_constants
+base_constants
...
+sysres_common_constants;const TAccountType="atUser atGroup atRole ";const TActionEnabledMode="aemEnabledAlways "
+"aemDisabledAlways "
+"aemEnabledOnBrowse "
+"aemEnabledOnEdit "
+"aemDisabledOnBrowseEmpty ";const TAddPosition="apBegin apEnd ";const TAlignment="alLeft alRight ";const TAreaShowMode="asmNever "
+"asmNoButCustomize "
+"asmAsLastTime "
+"asmYesButCustomize "
+"asmAlways ";const TCertificateInvalidationReason="cirCommon cirRevoked ";const TCertificateType="ctSignature ctEncode ctSignatureEncode ";const TCheckListBoxItemState="clbUnchecked clbChecked clbGrayed ";const TCloseOnEsc="ceISB ceAlways ceNever ";const TCompType="ctDocument "
+"ctReference "
+"ctScript "
+"ctUnknown "
+"ctReport "
...
+"ctJob "
+"ctNotice "
+"ctControlJob ";const TConditionFormat="cfInternal cfDisplay ";const TConnectionIntent="ciUnspecified ciWrite ciRead ";const TContentKind="ckFolder "
+"ckEDocument "
+"ckTask "
+"ckJob "
+"ckComponentToken "
...
+"ckScript "
+"ckReport "
+"ckDialog ";const TControlType="ctISBLEditor "
+"ctBevel "
+"ctButton "
+"ctCheckListBox "
+"ctComboBox "
...
+"ctInnerPanel "
+"ctPanelGroup "
+"ctBitButton ";const TCriterionContentType="cctDate "
+"cctInteger "
+"cctNumeric "
+"cctPick "
+"cctReference "
+"cctString "
+"cctText ";const TCultureType="cltInternal cltPrimary cltGUI ";const TDataSetEventType="dseBeforeOpen "
+"dseAfterOpen "
+"dseBeforeClose "
+"dseAfterClose "
+"dseOnValidDelete "
...
+"dseBeforeDetailUpdate "
+"dseOnPrepareUpdate "
+"dseOnAnyRequisiteChange ";const TDataSetState="dssEdit dssInsert dssBrowse dssInActive ";const TDateFormatType="dftDate dftShortDate dftDateTime dftTimeStamp ";const TDateOffsetType="dotDays dotHours dotMinutes dotSeconds ";const TDateTimeKind="dtkndLocal dtkndUTC ";const TDeaAccessRights="arNone arView arEdit arFull ";const TDocumentDefaultAction="ddaView ddaEdit ";const TEditMode="emLock "
+"emEdit "
+"emSign "
+"emExportWithLock "
+"emImportWithUnlock "
...
+"fdtUnknown "
+"fdtWideString "
+"fdtLargeInteger ";const TFolderType="ftInbox "
+"ftOutbox "
+"ftFavorites "
+"ftCommonFolder "
+"ftUserFolder "
...
+"ftQuickLaunch "
+"ftShortcuts "
+"ftSearch ";const TGridRowHeight="grhAuto "+"grhX1 "+"grhX2 "+"grhX3 ";const THyperlinkType="hltText "+"hltRTF "+"hltHTML ";const TImageFileFormat="iffBMP "
+"iffJPEG "
+"iffMultiPageTIFF "
+"iffSinglePageTIFF "
+"iffTIFF "
+"iffPNG ";const TImageMode="im8bGrayscale "+"im24bRGB "+"im1bMonochrome ";const TImageType="itBMP "+"itJPEG "+"itWMF "+"itPNG ";const TInplaceHintKind="ikhInformation "+"ikhWarning "+"ikhError "+"ikhNoIcon ";const TISBLContext="icUnknown "
+"icScript "
+"icFunction "
+"icIntegratedReport "
+"icAnalyticReport "
...
+"icEDocMethod "
+"icDialogMethod "
+"icProcessMessageHandler ";const TItemShow="isShow "+"isHide "+"isByUserSettings ";const TJobKind="jkJob "+"jkNotice "+"jkControlJob ";const TJoinType="jtInner "+"jtLeft "+"jtRight "+"jtFull "+"jtCross ";const TLabelPos="lbpAbove "+"lbpBelow "+"lbpLeft "+"lbpRight ";const TLicensingType="eltPerConnection "+"eltPerUser ";const TLifeCycleStageFontColor="sfcUndefined "
+"sfcBlack "
+"sfcGreen "
+"sfcRed "
+"sfcBlue "
+"sfcOrange "
+"sfcLilac ";const TLifeCycleStageFontStyle="sfsItalic "+"sfsStrikeout "+"sfsNormal ";const TLockableDevelopmentComponentType="ldctStandardRoute "
+"ldctWizard "
+"ldctScript "
+"ldctFunction "
+"ldctRouteBlock "
...
+"ldctEDocumentType "
+"ldctDialog "
+"ldctServerEvents ";const TMaxRecordCountRestrictionType="mrcrtNone "+"mrcrtUser "+"mrcrtMaximal "+"mrcrtCustom ";const TRangeValueType="vtEqual "+"vtGreaterOrEqual "+"vtLessOrEqual "+"vtRange ";const TRelativeDate="rdYesterday "
+"rdToday "
+"rdTomorrow "
+"rdThisWeek "
+"rdThisMonth "
...
+"rdNextWeek "
+"rdLastWeek "
+"rdLastMonth ";const TReportDestination="rdWindow "+"rdFile "+"rdPrinter ";const TReqDataType="rdtString "
+"rdtNumeric "
+"rdtInteger "
+"rdtDate "
+"rdtReference "
...
+"rdtUnknown "
+"rdtLargeInteger "
+"rdtDocument ";const TRequisiteEventType="reOnChange "+"reOnChangeValues ";const TSBTimeType="ttGlobal "+"ttLocal "+"ttUser "+"ttSystem ";const TSearchShowMode="ssmBrowse "+"ssmSelect "+"ssmMultiSelect "+"ssmBrowseModal ";const TSelectMode="smSelect "+"smLike "+"smCard ";const TSignatureType="stNone "+"stAuthenticating "+"stApproving ";const TSignerContentType="sctString "+"sctStream ";const TStringsSortType="sstAnsiSort "+"sstNaturalSort ";const TStringValueType="svtEqual "+"svtContain ";const TStructuredObjectAttributeType="soatString "
+"soatNumeric "
+"soatInteger "
+"soatDatetime "
+"soatReferenceRecord "
...
+"soatContents "
+"soatUnknown ";const TTaskAbortReason="tarAbortByUser "+"tarAbortByWorkflowException ";const TTextValueType="tvtAllWords "+"tvtExactPhrase "+"tvtAnyWord ";const TUserObjectStatus="usNone "
+"usCompleted "
+"usRedSquare "
+"usBlueSquare "
+"usYellowSquare "
...
+"wfepRadioGroupColumn3 ";const TWizardFormElementType="wfetQueryParameter "+"wfetText "+"wfetDelimiter "+"wfetLabel ";const TWizardParamType="wptString "
+"wptInteger "
+"wptNumeric "
+"wptBoolean "
+"wptDateTime "
...
+"wptContents "
+"wptFileName "
+"wptDate ";const TWizardStepResult="wsrComplete "
+"wsrGoNext "
+"wsrGoPrevious "
+"wsrCustom "
+"wsrCancel "
+"wsrGoFinal ";const TWizardStepType="wstForm "
+"wstEDocument "
+"wstTaskCard "
+"wstReferenceRecordCard "
+"wstFinal ";const TWorkAccessType="waAll "+"waPerformers "+"waManual ";const TWorkflowBlockType="wsbStart "
+"wsbFinish "
+"wsbNotice "
+"wsbStep "
+"wsbDecision "
...
+"wsbSubTask "
+"wsbLifeCycleStage "
+"wsbPause ";const TWorkflowDataType="wdtInteger "
+"wdtFloat "
+"wdtString "
+"wdtPick "
+"wdtDateTime "
...
+"wdtDeadLine "
+"wdtPickSet "
+"wdtAccountCollection ";const TWorkImportance="wiLow "+"wiNormal "+"wiHigh ";const TWorkRouteType="wrtSoft "+"wrtHard ";const TWorkState="wsInit "
+"wsRunning "
+"wsDone "
+"wsControlled "
+"wsAborted "
+"wsContinued ";const TWorkTextBuildingMode="wtmFull "+"wtmFromCurrent "+"wtmOnlyCurrent ";const ENUMS=TAccountType
+TActionEnabledMode
+TAddPosition
+TAlignment
+TAreaShowMode
...
+TWorkRouteType
+TWorkState
+TWorkTextBuildingMode;const system_functions="AddSubString "
+"AdjustLineBreaks "
+"AmountInWords "
+"Analysis "
+"ArrayDimCount "
...
+"ЦПодстр ";const predefined_variables="AltState "
+"Application "
+"CallType "
+"ComponentTokens "
+"CreatedJobs "
...
+"ВызовСпособ "
+"ИмяОтчета "
+"РеквЗнач ";const interfaces="IApplication "
+"IAccessRights "
+"IAccountRepository "
