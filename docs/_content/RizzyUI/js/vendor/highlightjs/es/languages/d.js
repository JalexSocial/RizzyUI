var hljsGrammar=(function(){'use strict';function d(hljs){const D_KEYWORDS={$pattern:hljs.UNDERSCORE_IDENT_RE,keyword:'abstract alias align asm assert auto body break byte case cast catch class '
...
return d;})();;export default hljsGrammar;