var hljsGrammar=(function(){'use strict';function isbl(hljs){const UNDERSCORE_IDENT_RE="[A-Za-zА-Яа-яёЁ_!][A-Za-zА-Яа-яёЁ_0-9]*";const FUNCTION_NAME_IDENT_RE="[A-Za-zА-Яа-яёЁ_][A-Za-zА-Яа-яёЁ_0-9]*";const KEYWORD="and и else иначе endexcept endfinally endforeach конецвсе endif конецесли endwhile конецпока "
...
return isbl;})();;export default hljsGrammar;