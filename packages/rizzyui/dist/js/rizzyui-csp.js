...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  function async_alpine_default(Alpine2) {
    ...
    async function download(name2) {
      ...
      const module2 = await getModule(name2);
      Alpine2.data(name2, module2);
      data2[name2].loaded = true;
    }
    async function getModule(name2) {
      if (!data2[name2]) return;
      const module2 = await data2[name2].download(name2);
      if (typeof module2 === "function") return module2;
      let whichExport = module2[name2] || module2.default || Object.values(module2)[0] || false;
      return whichExport;
    }
  ...
  function registerRzConfetti(Alpine2, require) {
  ...
  function registerRzHighlighter(Alpine2, require) {
  ...
  function registerRzTooltip(Alpine2) {
    Alpine2.data("rzTooltip", () => ({
      ...
      queueOpen() {
        ...
        const delay2 = this.skipDelayActive ? 0 : this.openDelayDuration;
        if (delay2 <= 0) {
          this.open = true;
          return;
        }
  ...
  function registerRzChart(Alpine2, require) {
